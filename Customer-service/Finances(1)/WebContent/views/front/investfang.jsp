...
<body>
    ...
    <div class="m2-investBread">
        <div class="m2-investBreadbox">
            ...
            <span class="m2-invBre-fat">爱房贷</span>
        </div>
    </div>
    ...
    <div class="m2-invTable-con">
       <ul class="m2-invTablelist"><!-- 只能显示7个，其余隐藏 -->
            ...
            <li class="m2-invTab-unsel" onclick="window.location.href='/Finances/toinvestche'"><span>爱车贷</span><i></i></li>
            <li class="m2-invTab-sel" onclick="window.location.href='/Finances/toinvestfang'"><span>爱房贷</span><i></i></li>
    ...
    <div class="m2-invResult-con">
        ...
        <!-- 爱房贷 -->
         <div class="m2-invResuleitem-box" id="resuleite3">
         	<c:if test="${afds==null || fn:length(afds) == 0}">
					<center>
            ...
            <ul>
            	<c:forEach items="${afds}" var="fabiaos">
	 ...
	 <c:if test="${fn:length(afds) > 0}">
		            <a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestfang?pageNow=1'" class="m2-pages-num m2-page-prev">&lt;</a>					
					<c:choose>
						<c:when test="${page.pageNow - 1 > 0}">
							<a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestfang?pageNow=${page.pageNow - 1}'"  class="m2-pages-num m2-page-sel"> - </a>
						</c:when>
						<c:when test="${page.pageNow - 1 <= 0}">
							<a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestfang?pageNow=1'"  class="m2-pages-num m2-page-sel"> - </a>
						</c:when>
					</c:choose>
					<c:choose>
						<c:when test="${page.totalPageCount==0}">
							<a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestfang?pageNow=${page.pageNow}'"   class="m2-pages-num m2-page-sel"> + </a>
						</c:when>
						...
						<c:when test="${page.pageNow + 1 >= page.totalPageCount}">
							<a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestfang?pageNow=${page.totalPageCount}'"  class="m2-pages-num m2-page-sel"> + </a>
						</c:when>
					</c:choose>
					<c:choose>
						<c:when test="${page.totalPageCount==0}">
							<a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestfang?pageNow=${page.pageNow}'" title="尾页" class="m2-pages-num m2-page-next">&gt;</a>
						</c:when>
						<c:otherwise>
							<a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestfang?pageNow=${page.totalPageCount}'" title="尾页" class="m2-pages-num m2-page-next">&gt;</a>
						</c:otherwise>
					</c:choose>
				</c:if>		
       	 ...
       	 $.get("/Finances/toProjectlikezt",p,function(d){
             	...
             	if(dataObj.status==1){
                 	var htmls = pingjie(dataObj.fabiaolist);
                 	 $("#resuleite3 ul").remove();
                 	 $("#resuleite3").html(htmls);
             	}
             });
         }
