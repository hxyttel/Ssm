...
<body>
    ...
    <div class="m2-investBread">
        <div class="m2-investBreadbox">
            ...
            <span class="m2-invBre-fat">消费基金</span>
        </div>
    </div>
    ...
    <div class="m2-invTable-con">
        <ul class="m2-invTablelist"><!-- 只能显示7个，其余隐藏 -->
            ...
            <li class="m2-invTab-sel" onclick="window.location.href='/Finances/toinvestjj'"><span>消费金融</span><i></i></li>
    ...
    <div class="m2-invResult-con">
        ...
        <!-- 消费基金 -->
         <div class="m2-invResuleitem-box" id="resuleite4">
         	<c:if test="${xfjjs==null || fn:length(xfjjs) == 0}">
					<center>
              ...
              <ul>
            	<c:forEach items="${xfjjs}" var="fabiaos">
           	 ...
           	 $.get("/Finances/toProjectlikezt",p,function(d){
                 	...
                 	if(dataObj.status==1){
                     	var htmls = pingjie(dataObj.fabiaolist);
                     	 $("#resuleite4 ul").remove();
                     	 $("#resuleite4").html(htmls);
                 	}
                 });
             }
