...
<body>
    ...
    <div class="m2-invTable-con">
        <ul class="m2-invTablelist"><!-- 只能显示7个，其余隐藏 -->
            <li class="m2-invTab-sel" onclick="window.location.href='/Finances/toinvestzt'"><span>项目直投</span><i></i></li>
    ...
    <div class="m2-invResult-con">
        ...
        <div class="m2-invResuleitem-box" id="resuleite0">
            <ul>
            	<c:if test="${fabiaolist==null || fn:length(fabiaolist) == 0}">
					<center>
         ...
         <div class="m2-newListpage-con" style="padding-top:5px;">
		     ...
		     <c:if test="${fn:length(fabiaolist) > 0}">
		               <a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestzt?pageNow=1'" class="m2-pages-num m2-page-prev">&lt;</a>					
					<c:choose>
						<c:when test="${page.pageNow - 1 > 0}">
							<a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestzt?pageNow=${page.pageNow - 1}'"  class="m2-pages-num m2-page-sel"> - </a>
						</c:when>
						<c:when test="${page.pageNow - 1 <= 0}">
							<a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestzt?pageNow=1'"  class="m2-pages-num m2-page-sel"> - </a>
						</c:when>
					</c:choose>
					<c:choose>
						<c:when test="${page.totalPageCount==0}">
							<a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestzt?pageNow=${page.pageNow}'"   class="m2-pages-num m2-page-sel"> + </a>
						</c:when>
						...
						<c:when test="${page.pageNow + 1 >= page.totalPageCount}">
							<a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestzt?pageNow=${page.totalPageCount}'"  class="m2-pages-num m2-page-sel"> + </a>
						</c:when>
					</c:choose>
					<c:choose>
						<c:when test="${page.totalPageCount==0}">
							<a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestzt?pageNow=${page.pageNow}'" title="尾页" class="m2-pages-num m2-page-next">&gt;</a>
						</c:when>
						<c:otherwise>
							<a href="javascript:void(0);" onclick="window.location.href='/Finances/toinvestzt?pageNow=${page.totalPageCount}'" title="尾页" class="m2-pages-num m2-page-next">&gt;</a>
						</c:otherwise>
					</c:choose>
				</c:if>		
		                </div>
