  ...
  //新增角色
	...
	$(function () {
		...
		$('#tb_role').bootstrapTable({
			url : '${pageContext.request.contextPath}/back/admin/selectsendMaillists', //请求后台的URL（*）
			method : 'post', //请求方式（*）
			...
			columns : [ {
				...
				title : '角色权限',
				formatter : function(value, row, index) {
					return "<a  onclick='rolist("+row.mailid+");' data-toggle='modal' data-target='#tb_model'><span class='glyphicon glyphicon-new-window'></span>权限设置</a>";
				}
			}, */]
		});
				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
							<div class="form-group">
		            			...
		            			<label for="operateTime" class="control-label col-sm-1">接口地址地址</label>
		            			<div class="col-sm-2">
	            					<input type="text" name="formName" class="form-control" id="formName">
	            				</div>
	            				<label for="operateTime" class="control-label col-sm-1">密码</label>
		            			<div class="col-sm-2">
	            					<input type="text" name="password" class="form-control" id="password">
	            				</div>
		            			<label for="operateTime" class="control-label col-sm-1">是否使用</label>
		            			<div class="col-sm-2">
